...
const ERROR_ITEM: React.CSSProperties = {
...
const WARNING_ITEM: React.CSSProperties = {
  ...ERROR_ITEM,
  color: "#ffcc44",
};
...
export default function DevErrorOverlay() {
  ...
  const addError = useCallback((message: string, type: "error" | "warn" = "error", source = "") => {
