            ...
            <VStack spacing={6} align="start">
              ...
              <Box>
                ...
                <Box pl={4} color={textColor}>
                  <Text as="b">50% de Anticipo:</Text> Al momento de la firma o aceptación del presupuesto.
                  <Text as="b" display="block">50% de Saldo:</Text> Se cancela una vez finalizada la entrega e instalación del trabajo, a su completa satisfacción.
                  <Text as="b" display="block">Medios de Pago:</Text> Aceptamos transferencias bancarias sin comisión. Los pagos realizados con tarjeta de crédito o débito están sujetos a un recargo administrativo del 5%.
                </Box>
              </Box>
              ...
              <Box>
                ...
                <Box pl={4} color={textColor}>
                  <Text as="b">Cobertura:</Text> Cubre defectos de fabricación del vidrio, aluminio y posibles fallas en la instalación.
                  <Text as="b" display="block">No incluye:</Text> No cubre roturas de vidrio posteriores a la entrega, rayaduras por limpieza inadecuada o daños derivados de un mal uso.
                </Box>
              </Box>
          ...
          >
            <VStack spacing={6} align="start">
              ...
              <Box>
                ...
                <Box pl={4} color={textColor}>
                  <Text as="b">Exclusiones:</Text> GYA Company no asume responsabilidad por retrasos derivados de causas ajenas a nuestra gestión, tales como demoras de otros contratistas, restricciones de acceso a las zonas de trabajo o modificaciones en el diseño original solicitadas durante el desarrollo de la obra.
                </Box>
              </Box>
              ...
              <Box>
                ...
                <Box pl={4} color={textColor}>
                  <Text as="b">Anticipo:</Text> Un porcentaje inicial (generalmente entre 10% y 20%) destinado a la programación y planificación de los trabajos.
                  <Text as="b" display="block">Materiales:</Text> Pago contra la llegada de los materiales a la obra (entre 20% y 30%).
                  <Text as="b" display="block">Avance:</Text> El saldo restante se liquidará mediante valorizaciones periódicas, en función del avance de la instalación en obra.
                </Box>
              </Box>
          ...
          >
            <VStack spacing={6} align="start">
              ...
              <Box>
                ...
                <Box pl={4} color={textColor} gap={2}>
                  <Text as="b">Consentimiento:</Text> El tratamiento de sus datos siempre mediará su consentimiento previo, expreso e informado.
                  <Text as="b" display="block">Finalidad:</Text> Sus datos serán utilizados exclusivamente para los fines del servicio contratado.
                  <Text as="b" display="block">Seguridad:</Text> Implementamos medidas técnicas para evitar la pérdida, mal uso o acceso no autorizado a su información.
                </Box>
              </Box>
