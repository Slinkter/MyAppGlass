/**
 * @file liquidGlassStyles.ts
 * @description Style utility hooks for applying high-performance glassmorphism effects to components.
 * @module utils/styles
 */
...
/**
 * Interface for Liquid Glass Button style properties.
 */
 ...
 * @returns Chakra UI style props object for glass button.
 * @remarks
 * - Optimized for interactive elements with hover states.
 * - Uses slightly less blur (15px) than containers for clarity.
 */
export const useLiquidGlassButtonProps = (): LiquidGlassButtonProps => {
