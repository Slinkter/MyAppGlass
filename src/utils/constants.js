...
export const FEATURE_TEXTS = {
  ...
  MATERIALES_DESCRIPTION:
    "Utilizamos materiales de alta calidad para asegurar la durabilidad y el mejor acabado en todos nuestros proyectos.", // Corrected description
  ...
  GARANTIAS_DESCRIPTION:
    "Disfruta de una garantía de 6 meses en todos nuestros productos instalados.", // Consolidated to 6 months
