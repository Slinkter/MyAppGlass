...
export const useLiquidGlassProps = () => {
  const bgColor = useColorModeValue("rgba(255, 255, 255, 0.15)", "rgba(0, 0, 0, 0.15)");
  const borderColor = useColorModeValue("rgba(255, 255, 255, 0.25)", "rgba(255, 255, 255, 0.15)"); // Adjusted for dark mode visibility
...
export const useLiquidGlassButtonProps = () => {
  const buttonBg = useColorModeValue("rgba(255, 255, 255, 0.1)", "rgba(0, 0, 0, 0.1)");
  const buttonBorderColor = useColorModeValue("rgba(255, 255, 255, 0.4)", "rgba(255, 255, 255, 0.2)");
  const buttonHoverBg = useColorModeValue("rgba(255, 255, 255, 0.2)", "rgba(0, 0, 0, 0.2)");
  const buttonHoverBorderColor = useColorModeValue("rgba(255, 255, 255, 0.6)", "rgba(255, 255, 255, 0.3)");
