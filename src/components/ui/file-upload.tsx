...
interface FileUploadItemProps extends ChakraFileUpload.ItemProps {
  file: File
  showSize?: boolean
  clearable?: boolean
}
...
const FileUploadItem = React.forwardRef<HTMLLIElement, FileUploadItemProps>(
  function FileUploadItem(props, ref) {
    const { file, showSize, clearable, ...rest } = props
    return (
...
export interface FileUploadListProps extends ChakraFileUpload.ItemGroupProps {
  showSize?: boolean
  clearable?: boolean
  files?: File[]
}
...
export const FileInput = React.forwardRef<HTMLButtonElement, FileInputProps>(
  function FileInput(props, ref) {
    ...
    const { placeholder = "Seleccionar archivo(s)", ...rest } = restProps
    return (
