...
export const services: Service[] = [
    {
        ...
        category: "Aluminio",
        description:
            "Ventanas de aluminio con sistemas Nova, Serie 25 y 31. Ideal para proyectos residenciales y comerciales.",
    ...
    },
    {
        ...
        category: "Vidrio",
        description:
            "Mamparas de baño en vidrio templado. Sistemas Nova y Serie 25 con acabados en natural y negro.",
    ...
    },
    {
        ...
        category: "Vidrio",
        description:
            "Boxes de ducha con vidrio templado de 8mm. Sistemas KIT y Acrílico disponibles.",
        link: "https://www.facebook.com/media/set/?set=a.414060420462826&type=3?from=GoogleBT",
        plink: "/servicios/ducha",
    },
    {
        id: 4,
        image: "/images/services-products-05.Parapeto-IMG_20250808_131220.webp",
        name: "Parapeto",
        category: "Vidrio",
        description:
            "Parapetos de vidrio templado con estructura de acero o aluminio. Acabados profesionales.",
    ...
    },
    {
        ...
        category: "Vidrio",
        description:
            "Barandas de vidrio templado con accesorios de acero cromado. Seguridad y elegancia.",
        link: "https://www.facebook.com/gyacompany?from=GoogleBT",
        plink: "/servicios/baranda",
    },
    {
        id: 6,
        image: "/images/services-products-07.Balcones-IMG_0759.webp",
        name: "Balcones",
        category: "Cerramientos",
        description:
            "Balcones de vidrio templado con arenado decorativo. Diseño moderno y seguro.",
    ...
    },
    {
        ...
        category: "Cerramientos",
        description:
            "Techos de policarbonato con estructura de aluminio. Protección e iluminación natural.",
    ...
    },
    {
        ...
        category: "Vidrio",
        description:
            "Puertas de vidrio templado con chapa bola y accesorios de calidad.",
        link: "https://www.facebook.com/gyacompany/?from=GoogleBT",
    ...
    },
    {
        ...
        category: "Aluminio",
        description:
            "Puertas enrollables de aluminio con plancha arenada. Resistencia y durabilidad.",
        link: "https://www.facebook.com/gyacompany/?from=GoogleBT",
        plink: "/servicios/pserie",
    },
    {
        id: 10,
        image: "/images/services-products-13.Celosias-IMG_2172.webp",
        name: "Celosías",
        category: "Aluminio",
        description:
            "Celosías de aluminio para ventilación de espacios. Funcionalidad y diseño.",
        link: "https://www.facebook.com/gyacompany/?from=GoogleBT",
