...
export const SERVICE_AR_MODELS_MAP: Record<string, Record<string, SystemARConfig>> = {
  ...
  ducha: {
    "Sistema Corredizo KIT Acero": {
      ...
      glbModelUrl: "/models/ducha/default.glb",
      usdzModelUrl: "/models/ducha/default.glb",
  ...
  parapeto: {
    "Sistema Parapeto Panorámico": {
      ...
      glbModelUrl: "/models/parapeto/default.glb",
      usdzModelUrl: "/models/parapeto/default.glb",
  ...
  baranda: {
    "Sistema Baranda Minimalista": {
      ...
      glbModelUrl: "/models/baranda/default.glb",
      usdzModelUrl: "/models/baranda/default.glb",
  ...
  balcones: {
    "Sistema Panorámico": {
      ...
      glbModelUrl: "/models/balcones/default.glb",
      usdzModelUrl: "/models/balcones/default.glb",
  ...
  techo: {
    "Sistema Cobertura Aluminio": {
      ...
      glbModelUrl: "/models/techo/default.glb",
      usdzModelUrl: "/models/techo/default.glb",
  ...
  pvidrio: {
    "Sistema Pivotante con Freno de Piso": {
      ...
      glbModelUrl: "/models/pvidrio/default.glb",
      usdzModelUrl: "/models/pvidrio/default.glb",
  ...
  pserie: {
    "Sistema Puerta Serie": {
      ...
      glbModelUrl: "/models/pserie/default.glb",
      usdzModelUrl: "/models/pserie/default.glb",
  ...
  celosias: {
    "Sistema Celosía Fija y Móvil": {
      ...
      glbModelUrl: "/models/celosias/default.glb",
      usdzModelUrl: "/models/celosias/default.glb",
