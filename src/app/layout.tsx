...
export const metadata: Metadata = {
    ...
    description:
        "Especialistas en vidriería, instalación de ventanas antirruido, mamparas de vidrio templado y aluminio en La Molina, Surco y Lima. ¡Cotiza a domicilio!",
    keywords: [
        "vidriería la molina",
        "vidrio y aluminio",
        "ventanas antirruido lima",
        "mamparas para baño",
    ...
    return (
        <html lang="es" suppressHydrationWarning className={lora.variable}>
            <head>
                ...
                />
                <script
                    src={`https://www.google.com/recaptcha/api.js?render=${process.env.NEXT_PUBLIC_RECAPTCHA_SITE_KEY || "6LfmMIktAAAAAAMpZBhN56QIkjXT9U34Dyk56nlx"}`}
                    async
                    defer
                />
            </head>
