...
const InfoItem: React.FC<InfoItemProps> = ({ icon, label, value, copyable = false }) => {
  return (
    <HStack
      p={4}
      gap={4}
...
const BankAccountCard: React.FC<BankAccount> = ({ logo, bankName, accountType, accounts, logoBg = "gray.50" }) => {
  return (
    <AuraSurface
      display="flex"
