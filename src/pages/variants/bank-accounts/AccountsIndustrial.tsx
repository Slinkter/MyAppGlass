...
const IndustrialCard: React.FC<IndustrialCardProps> = ({ logo, bankName, accountType, accounts }) => (
  <Box 
    bg="bg.section" 
    border="1px solid" 
  ...
  >
    <Flex direction={{ base: "column", md: "row" }}>
      <Box bg="primary.900" _dark={{ bg: "primary.100" }} p={6} display="flex" alignItems="center" justifyContent="center" minW="180px">
...
export const AccountsIndustrial: React.FC = () => (
  <Box py={10}>
