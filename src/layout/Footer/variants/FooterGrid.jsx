...
const FooterGrid = () => {
  return (
    ...
    >
      ...
      <Container maxW="7xl">
        <SimpleGrid columns={{ base: 1, sm: 2, lg: 4 }} spacing={12} mb={20}>
          <VStack align="flex-start" spacing={8} pr={{ lg: 12 }} borderRight={{ lg: "1px solid" }} borderColor="border.glass">
          ...
          <FooterSection title="Contacto">
            <HStack spacing={3} color="text.body">
              <Icon as={FaWhatsapp} color="brand.whatsapp" />
