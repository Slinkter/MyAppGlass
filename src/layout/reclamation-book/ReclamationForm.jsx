 ...
 * Maneja la entrada de datos del usuario, validación y envío de reclamos/quejas.
 * Integra `useReclamoForm` para la lógica y `SuccessModal` para confirmación.
 *
          ...
          <Stack spacing={5}>
            ...
            <FormControl isRequired isInvalid={!!errors.aceptaTerminos}>
              <Checkbox
                ...
                onChange={handleInputsChange}
              >
                Declaro que la información proporcionada es veraz y acepto la
